				...
				<table class="table ">
					...
					<tr>
						...
						<th><input type="hidden" name="loginId"
							...
							type="hidden" name="profile" value="${param.profile}"> <%-- 確認ボタン --%>
							<button type="submit" name="btn" class="btn btn-right" value="はい">はい</button>
							<button type="submit" name="btn" class="btn btn-left" value="いいえ">いいえ</button></th>
					</tr>
				</table>
